  ...
  <div class="createCargo">
    <div>
        ...
        <b-row>
          ...
          <b-col lq="2"> <label>Имущество (выберите, если необходимо изменить информацию)</label></b-col>
          <b-col lq="2"> <label>Наименование</label></b-col>
          <b-col lq="2"> <label>Единицы измерения</label></b-col>
          <b-col cols="1"></b-col>
        ...
        <b-row>
          ...
          <b-col lq="2"> 
            <b-form-select v-model="cargo"  @change="selectChange" id="selector"> 
          ...
          <b-col lq="2"> <b-form-input v-model="name"  @update="infChange"
            type='text' 
          ...
          <b-col lq="2"> <b-form-select v-model="unit"  @change="infChange">
